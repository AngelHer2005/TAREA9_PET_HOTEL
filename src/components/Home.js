...
function Home() {
  return (
    <div>
      <header>
        <a href="#" className="logo text-center">PET HOTEL</a>
        <nav>
          <ul>
            <li>
      ...
      <main>
        ...
        <div className="Servicios" id="Servicios">
          ...
          <div className="ser3">
            ...
            <p>
              Brindamos paseos diarios y actividades recreativas supervisadas
              para que tu mascota se mantenga activa y entretenida durante su
              estancia. Nuestro personal capacitado se asegura de que tu mascota
              reciba el ejercicio y la estimulación mental adecuados.
            </p>
          </div>
          <div className="ser4">
            <img
            ...
            <p>
              Proporcionamos dietas personalizadas y atención especializada para
              mascotas con necesidades dietéticas específicas. Nos aseguramos
              de que tu mascota reciba la alimentación adecuada según sus
